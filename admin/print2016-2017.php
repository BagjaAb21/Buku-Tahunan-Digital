...
include 'connect.php';
$result = mysql_query("SELECT * from murid AS m INNER JOIN kelas AS k ON k.id_kls = m.kode_kelas where angkatan in ('2016/2017') ORDER BY m.angkatan ASC")or die(mysql_error());
$column_Nama = "";
$column_Kelas = "";
$column_Tempat = "";
$column_Tanggal = "";
