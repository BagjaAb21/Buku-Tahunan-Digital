...
$pdf->Cell(75,6,'Tempat Tanggal Lahir',1,1,'C');
 
$pdf->SetFont('Arial','',10);
 
include 'connect.php';
$result = mysql_query("SELECT * from murid AS m INNER JOIN kelas AS k ON k.id_kls = m.kode_kelas ORDER BY m.angkatan, k.id_kls ASC")or die(mysql_error());
$column_Nama = "";
$column_Kelas = "";
$column_Tempat = "";
$column_Tanggal = "";
