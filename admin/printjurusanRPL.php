...
$pdf->Cell(284,7,'DAFTAR ALUMNI',0,1,'C');
 $pdf->SetFont('Arial','B',12);
$pdf->Cell(284,7,'REKAYASA PERANGKAT LUNAK',0,1,'C'); 
...
$pdf->Cell(55,6,'Sosial Media',1,1,'C');
 
$pdf->SetFont('Arial','',10);
 
include 'connect.php';
$result = mysql_query("SELECT murid.nama, murid.kode_kelas, murid.tempat, murid.tanggal, murid.sosmed, murid.angkatan, kelas.kelas FROM murid LEFT JOIN kelas on murid.kode_kelas=kelas.id_kls WHERE kelas in ('XII REKAYASA PERANGKAT LUNAK 1','XII REKAYASA PERANGKAT LUNAK 2')")or die(mysql_error());
$column_Nama     = "";
$column_Kelas    = "";
$column_Tempat   = "";
$column_Tanggal  = "";
