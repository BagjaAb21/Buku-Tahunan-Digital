		   		...
		   		<div class="container">
		   			<div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
		   				<div class="slider-text-inner desc">
		   					...
		   					<p class="fh5co-lead"> <i class="icon-heart3"></i><a href="http://freehtml5.co" target="_blank">GALLERY KAMI</a></p>
		   				</div>
		   			</div>
		   		</div>
		   	</li>
			...
			<div class="row">
				<div class="col-lg-6 col-md-6">
					<div class="fh5co-blog animate-box">
						<img class="img-responsive" src="assets/user3.png" alt="">
						<div class="blog-text">
							<center><h3>ANGKATAN 2016/2017</a></h3></center>
							<a href="gallery2016-2017.php" class="btn btn-primary">View</a>
						</div> 
					</div>
				</div>
				<div class="col-lg-6 col-md-6">
					<div class="fh5co-blog animate-box">
						<img class="img-responsive" src="assets/user3.png" alt="">
						<div class="blog-text">
							<center><h3><a href="#">ANGKATAN 2017-2018</a></h3></center>
							<a href="gallery2017-2018.php" class="btn btn-primary">View</a>
						</div> 
					</div>
				</div>
			</div>
