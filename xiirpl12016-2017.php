...
<html>
          ...
          <div class="container">
            <div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
             <div class="slider-text-inner desc">
                <h2 class="heading-section">XII REKAYASA PERANGKAT LUNAK 1</h2>
                <p class="fh5co-lead">ANGKATAN<i class="icon-heart3"></i><font color="red"> 2016/2017</font></a></p>
            </div>
            </div>
          </div>
        </li>
  ...
  <br>
<?php
  $q=mysql_query("SELECT * FROM murid where kode_kelas= 7 and angkatan in ('2016/2017')ORDER BY nama ASC");
  $jml_kolom=4;
