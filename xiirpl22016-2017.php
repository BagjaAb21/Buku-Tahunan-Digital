...
<html>
          ...
          <div class="container">
            <div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
             <div class="slider-text-inner desc">
                <h2 class="heading-section">XII REKAYASA PERANGKAT LUNAK 2</h2>
  ...
  <br>
<?php
  $q=mysql_query("SELECT * FROM murid where kode_kelas= 8 and angkatan in ('2016/2017')ORDER BY nama ASC");
  $jml_kolom=4;
