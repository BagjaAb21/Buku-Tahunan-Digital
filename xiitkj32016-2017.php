...
<html>
          ...
          <div class="container">
            <div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
             <div class="slider-text-inner desc">
                <h2 class="heading-section">XII TEKNIK KOMPUTER JARINGAN 3</h2>
  ...
  <br>
<?php
  $q=mysql_query("SELECT * FROM murid where kode_kelas= 11 and angkatan in ('2016/2017')ORDER BY nama ASC");
  $jml_kolom=4;
